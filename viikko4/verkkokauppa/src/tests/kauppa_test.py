...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilimaksu_kutsuu_metodia_oikeilla_parametreilla(self):
        self._kauppa.tilimaksu("pekka", "12345")
        self._pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", "33333-44455", ANY)

    def test_ostetaan_kaksi_eri_tuotetta_ja_hinta_on_oikein(self):
        self._kauppa.aloita_asiointi()
        self._kauppa.lisaa_koriin(1)
    ...
    def test_ostetaan_kaksi_samaa_tuotetta_ja_hinta_on_oikein(self):
        self._kauppa.aloita_asiointi()
        self._kauppa.lisaa_koriin(2)
        self._kauppa.lisaa_koriin(2)
        self._kauppa.tilimaksu("pekka", "12345")
        self._pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", "33333-44455", 4)
    ...
    def test_ostetaan_kaksi_samaa_tuotetta_ja_hinta_on_oikein(self):
        ...
        self._kauppa.tilimaksu("pekka", "12345")
        self._pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", "33333-44455", 2)
